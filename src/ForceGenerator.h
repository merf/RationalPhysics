...
public:
	...
	m_Damping(damping)
	{
		m_SimObjectA = boost::shared_ptr<CSimObjectBase>(p_obj_a);
		m_SimObjectB = boost::shared_ptr<CSimObjectBase>(p_obj_b);
...
private:
	...
	boost::shared_ptr<CSimObjectBase> m_SimObjectA;
	boost::shared_ptr<CSimObjectBase> m_SimObjectB;
};
